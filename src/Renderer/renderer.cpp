...
void Renderer::draw(glm::vec3 positions[10])
{
    shader.use();
    ...
    for(uint i = 0; i < 10; i++)
    {
        ...
        float angle = 20.0f * i;
        model = glm::rotate(model, glm::radians(angle) + (float)glfwGetTime(), glm::vec3(0.2f, 0.5f, 1.0f));
